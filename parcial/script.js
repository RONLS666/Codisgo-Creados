    ...
    */
    ...
    var decimalFraccionario = function()
    {
        ...
        */
        ...
        var con = Math.pow(10, String(datosDecimal.decimal).length);
        //(datosDecimal.entero * con) + datosDecimal.decimal;

        var res = ((datosDecimal.entero * con) + datosDecimal.decimal) + "/" + con;

        //console.log(datosDecimal, res);
        //Imprime la respuesta en la vista (HTML)...
        nom_div("resFraccionario").innerHTML = simplificaFraccionario(res);
    };
